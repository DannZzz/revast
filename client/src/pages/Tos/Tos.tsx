  ...
  return (
    <div class="terms">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Armenia
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to Revast.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Revast, accessible from{" "}
            <a
              href="https://www.revast.fun"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.revast.fun
            </a>
          </p>
        </li>
        <li>
